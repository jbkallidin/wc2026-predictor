...
export default function ResetPasswordPage() {
  ...
  // The recovery link establishes a temporary session. Confirm it exists.
  useEffect(() => {
          ...
          <div className="p-8">
            {done ? (
              <>
                ...
                <p className="text-gray-500 text-sm">Taking you to your predictions…</p>
              </>
            ) : !ready ? (
              <>
                <h2 className="text-xl font-black text-white mb-1">Invalid or expired link</h2>
              ...
              <>
                <h2 className="text-xl font-black text-white mb-1">Set a new password</h2>
